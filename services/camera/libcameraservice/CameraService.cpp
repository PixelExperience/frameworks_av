...
#include <vendor/oplus/hardware/cameraMDM/1.0/IOPlusCameraProvider.h>
#endif
...
#ifdef CAMERA_NEEDS_CLIENT_INFO_LIB
using ::vendor::oplus::hardware::cameraMDM::V1_0::IOPlusCameraProvider;
#endif
...
#ifdef CAMERA_NEEDS_CLIENT_INFO_LIB
static const sp<IOPlusCameraProvider> gVendorCameraProviderService = IOPlusCameraProvider::getService();
#endif
